...
<body>
  ...
  <div class="container">
    ...
    <h1>Daftar Barang</h1>
    <a href="v_tambah_barang.php" class="btn btn-success">Tambah Barang</a>
    <br>
    <br>
    <table class="table">
      <tr>
      ...
      ?>
        <tr>
          ...
          <td>
            <a href="m_hapus_barang.php?id_barang=<?= $barang['id_barang'] ?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus?')">Hapus</a>
          </td>
        </tr>
      <?php } ?>
    </table>
